...
while ($row = mysqli_fetch_assoc($result)) {
    ...
    <div class="col-md-3">
        <div class="card my-3" style="width: 18rem;">
            ...
            <div class="card-body">
                <h5 class="card-title"><a href="threads.php?catid=' . $id . '&uid=' . $uid . '" style="text-decoration: none;">' . $img . '</a></h5>
                <p class="card-text">' . substr($row['c_description'], 0, 100) . '</p>
                <a href="threads.php?catid=' . $id . '&uid=' . $uid . '" class="btn btn-primary">View Threads</a>
            </div>
        </div>
    </div>';
}
